...
const initSecondStyle = () => {
  if (document.querySelector(".history-item")) {
    ...
    //   ]; //返回最后一个
    // @ts-ignore
    let theFirstHistory = document.querySelectorAll(".history-item")[0]; //返回最后一个
    let theFirstHistory2 = document.querySelector(".history-item"); //返回最后一个
    console.log(theFirstHistory);
    console.log(theFirstHistory2);
    // @ts-ignore
