            ...
            <div v-if="m.isBot" class="bot-say">
              ...
              <div>
                <span
                  ...
                  v-html="m.content"
                ></span>
                <span class="cursor" v-show="outputFlag"></span>
              </div>
            </div>
...
@keyframes inputEffect {
  0% {
    border-top-color: rgb(88, 173, 240, 0.7);
    background: linear-gradient(to right, rgb(88, 173, 240, 0.7), rgb(88, 173, 240, 1) 20%);
  }
  25% {
    border-right-color: rgb(88, 173, 240, 0.7);
    background: linear-gradient(to right, rgb(88, 173, 240, 0.7), black 40%);
  }
  50% {
    border-bottom-color: rgb(88, 173, 240, 0.7);
    background: linear-gradient(to right, rgb(88, 173, 240, 0.7), black 60%);
  }
  75% {
    border-left-color: rgb(88, 173, 240, 0.7);
    background: linear-gradient(to right, rgb(88, 173, 240, 0.7), black 80%);
  }
  100% {
    border-color: rgb(88, 173, 240, 0.7); /* 控制闪光的颜色 */
    background: linear-gradient(to right, rgb(88, 173, 240, 0.7), black 100%);
  }
}
</style>
