...
let resizeHeight = function () {
  ...
  // @ts-ignore
  maxHeight.value = domMessages.getElementsByClassName.height;
};
onMounted(() => {
  //设置容器高宽
  resizeMainContainer();
...
<template>
  <div id="main-container">
    <div class="message-wapper">
      <div class="head-title"><h3>欢迎来到haoGPT!</h3></div>

      <div class="messages">
        <el-scrollbar :max-height="maxHeight" style="padding-top: 20px">
          <div
