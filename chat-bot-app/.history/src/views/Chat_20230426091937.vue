...
@keyframes buttonEffect {
  0% {
    background: radial-gradient(ellipse 20px 8px, rgb(88, 173, 240, 0.3), rgb(88, 173, 240, 1), black);
  }
  20% {
    background: radial-gradient(ellipse 30px 12px, rgb(88, 173, 240, 0.3), black, black);
  }
  40% {
    background: radial-gradient(ellipse 40px 16px, rgb(88, 173, 240, 0.3), black, black);
  }
  60% {
    background: radial-gradient(ellipse 50px 20px, rgb(88, 173, 240, 0.3), black, black);
  }
  80% {
    background: radial-gradient(ellipse 60px 24px, rgb(88, 173, 240, 0.3), black, black);
  }
  100% {
    background: radial-gradient(ellipse 70px 280px, rgb(88, 173, 240, 0.3), black, black);
  }
}
.inputStyle {
  width: 400px;
