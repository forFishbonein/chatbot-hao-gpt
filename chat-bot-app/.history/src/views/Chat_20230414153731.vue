...
const clickToSend = () => {
  if (prompt.value) {
    if (requestingFlag === false) {
      ...
      var textContainers = document.getElementsByClassName("content-reply-bot"); // 获取文本容器列表
      var textContainer =
        document.getElementsByClassName("content-reply-bot")[
          textContainers.length - 1
        ]; // 获取文本容器
      textContainer.innerHTML = messages.value[-1].content;
        ...
        <el-scrollbar :max-height="maxHeight">
          ...
          >
            <div v-if="m.isBot" class="bot-say">
              ...
              <div class="content-reply-bot"></div>
            </div>
