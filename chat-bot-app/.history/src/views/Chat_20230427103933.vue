...
const outputText = (data) => {
  ...
  timer = setInterval(type, 100); // 每隔100ms调用type函数
};
...
const setRightMenu = () => {
  ...
  myElement.addEventListener("contextmenu", function (e) {
    ...
    contextMenu.innerHTML = "菜单项1<br>菜单项2<br>菜单项3";
    ...
    contextMenu.addEventListener("click", function (e) {
      // @ts-ignore
      var selectedMenuItem = e.target.innerHTML;
      alert("选择了菜单项：" + selectedMenuItem);
...
<template>
  ...
  <div id="customContextMenu">菜单项1<br />菜单项2<br />菜单项3</div>
</template>
